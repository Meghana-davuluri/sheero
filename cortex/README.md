...
This is the most important folder in Sheero. It holds everything the assistant needs to understand who it's working for, what they're doing, and what matters right now.

Sheero reads these files on demand — not all at once. CLAUDE.md tells it when to load each one.

---

## Files in This Folder

| File              | Purpose                                        | When Sheero Reads It                             |
|-------------------|------------------------------------------------|-------------------------------------------------|
...
- Fill in `me.md`, `work.md`, and `priorities.md` first — these are the minimum required for Sheero to be useful
